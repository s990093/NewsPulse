...
if __name__ == "__main__":
    ...
    new_news_df = df[~df['id'].isin(existing_ids)]
    ...
    with ThreadPoolExecutor(max_workers=max_workers) as executor:
        futures = {executor.submit(analyze_news, news["id"], news["content"], news["title"]): index for index, news in new_news_df.iterrows()}
